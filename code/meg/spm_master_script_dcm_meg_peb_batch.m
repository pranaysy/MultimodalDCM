...
% Use the file: MEEG_DCMreadyData_with_GainMatrix.tar.xz from the FigShare link for MEG
% Use the file: MEEG_DCMreadyData_with_GainMatrix_BEM.tar.xz for EEG (includes BEM)
